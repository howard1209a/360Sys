...
tile_dir="${base_dir}video${video_num}/tile/2*2/tile"
...
do
  ...
  do
    ...
    -i "${input_tile_video}" \
    -map 0:v:0 -c:v:0 libx264 -profile:v:0 main -crf:v:0 18 -g 50 \
    -map 0:v:0 -c:v:1 libx264 -profile:v:1 main -crf:v:1 51 -g 50 \
    -f dash \
    -segment_time 2 \  # 设置每个分片时长为2秒
